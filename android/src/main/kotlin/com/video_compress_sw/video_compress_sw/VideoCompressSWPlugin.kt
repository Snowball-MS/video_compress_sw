...
/** VideoCompressSWPlugin */
class VideoCompressSWPlugin: FlutterPlugin, MethodCallHandler {
  ...
  override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
    ...
    when (call.method) {
      "getByteThumbnail" -> {
        ...
        ThumbnailUtility(channelName).getByteThumbnail(path!!, quality, position.toLong(), maxWidth, maxHeight, result)
      }
      "getFileThumbnail" -> {
        val path = call.argument<String>("path")
        val quality = call.argument<Int>("quality")!!
